          ...
          >
            <div className="flex items-center gap-3 lg:gap-4">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-purple-500/10 rounded-xl flex items-center justify-center">
                <DollarSign className="w-5 h-5 lg:w-6 lg:h-6 text-purple-500" />
              </div>
              <div>
              ...
              <div className="flex gap-2 flex-wrap">
                <div className="relative">
                  <select
                    ...
                    className="appearance-none bg-gray-800 border border-gray-700 rounded-lg px-3 lg:px-4 py-2 text-gray-400 hover:text-white transition-colors text-sm pr-8"
                  >
